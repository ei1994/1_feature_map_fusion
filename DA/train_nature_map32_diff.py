...
checkpoint_dir = 'ckpt_map32_diff'
checkpoint_file = os.path.join(checkpoint_dir, 'model.ckpt')
train_dir='summary'

def initLogging(logFilename='record_map32_diff.log'):
  """Init for logging
  """
  logging.basicConfig(
                    level    = logging.DEBUG,
    ...
    with graph.as_default():
        ...
        with tf.Session(config=sess_config) as sess:
            ...
            try:
                ...
                np.save(os.path.join(checkpoint_dir,'ckpt_map32_diff'), all_loss)
...
#            saver.restore(sess, 'ckpt_tensor/model.ckpt-4000')
        ...
        #       绘制ROC曲线
                ...
                save_file.write('\n')
                save_file.close()
                roc_dir = 'plot_curve/roc/nature_map32_diff/epoch_'+str(number)
                try:
                    os.makedirs(roc_dir)
                except os.error:
                    pass
